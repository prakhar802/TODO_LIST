       ...
       <>
            <div className="main-div">
                <div className="child-div">
                     <figure>
                         <img src="./images/im.svg" alt="todoLogo" />
                    ...
                    <div className="addItems">
                        ...
                        { toogleSubmit ? <i className="fa fa-plus add-btn" title="Add item" onClick={() => addItem()}></i> :  <i className="fa fa-solid fa-pencil" title="Edit item" onClick={addItem}></i> }
                                ...
                                return (
                                    <div className="eachItem" key={elem.id}>
                                        ...
                                        <div className='todo-btn'>
                                            <i className="fa fa-solid fa-pencil" title="Edit item" onClick={() => editItem(elem.id)}></i>
                                            <i className="fa fa-solid fa-trash" title="Delete item" onClick={() => deleteItem(elem.id)}></i>
                                        </div>
